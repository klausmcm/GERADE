...
if __name__ == "__main__":
    ...
    for k in range( 3 ):
        barcode       = Barcode( constants.SMALL_LABEL_SPECS, module_size, "aaaa", constants )
        barcode_label = BarcodeLabel( constants.SMALL_LABEL_SPECS, "aaaa", constants )
        ...
        for i in range( len( page.get_grid_coordinates() ) ):
            ...
            barcode       = Barcode( constants.SMALL_LABEL_SPECS, module_size, id_var, constants )
            barcode_label = BarcodeLabel( constants.SMALL_LABEL_SPECS, id_var, constants )
            label         = Label( constants.SMALL_LABEL_SPECS, barcode, barcode_label )
